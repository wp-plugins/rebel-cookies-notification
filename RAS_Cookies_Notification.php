...
wp_register_script('jquery_cookies_script', plugins_url('RAS_Cookies_Notification/jquery.cookie.js'), array(), '1.0.0', true);
wp_enqueue_script('jquery_cookies_script');
wp_register_script('rebel_cookies_logo_script', plugins_url('RAS_Cookies_Notification/javascript.js'), array(), '1.0.0', true);
wp_enqueue_script('rebel_cookies_logo_script');
wp_register_style('rebel_cookies_logo_styles', plugins_url('RAS_Cookies_Notification/style.css'));
